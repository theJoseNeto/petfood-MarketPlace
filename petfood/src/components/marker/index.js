import './style.css';
import MarkerIconRed from '../../assets/markerRed.png';
import MarkerIconGreen from '../../assets/markerGreen.png';

const Marker = () => {
   return (
      <div>
         <img src={MarkerIconGreen} alt="Marker" className="marker-icon" />
